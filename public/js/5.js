...
$(document).ready(() => {
    ...
    $('.echoOne, .echoTwo, .echoThree, .echoFour').on('click', (e) => {

        let $sidePaneBodyText = $('#sidePaneBodyText');
        let echoClass = e.target.getAttribute('class');
        switch (echoClass) {
            case 'echoOne':
                $sidePaneBodyText.html(echoOneHtml);
                break;
            case 'echoTwo':
                $sidePaneBodyText.html(echoTwoHtml);
                break;
            case 'echoThree':
                $sidePaneBodyText.html(echoThreeHtml);
                break;
            case 'echoFour':
                $sidePaneBodyText.html(echoFourHtml);
                break;
        }
