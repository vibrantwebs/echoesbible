...
<head>
    ...
    <link href="/OLD/css/index3.css" rel="stylesheet">
    <script src="/OLD/js/4b.js"></script>
</head>
<body>
<div class="d-flex">
    ...
    <main class="flex-fill p-4">
        ...
        <div class="card text-center">
            ...
            <div class="card-body">
                ...
                <div class="container">
                    <div class="row">
                        <div id="echoGroupLeft" class="textLeft col-xs-12 col-sm-6">
                            <h3>Numbers</h3>
                            <br>
                        ...
                        <div id="echoGroupRight" class="textLeft col-xs-12 col-sm-6">
                            <h3>1 Corinthians</h3>
                            <br>
